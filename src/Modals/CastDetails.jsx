    ...
    return (
        <IonPage>
            ...
            <IonContent className="ContentBackground" style={{ textAlign: 'center' }}>
                ...
                <ThumbSlider title={'Movie Credits'} path="movie" url={`https://api.themoviedb.org/3/person/${id}/movie_credits?api_key=046fdb0d753c6903e673934705cb553f&language=en-US&page=1`} />
                <ThumbSlider title={'TV Credits'} path="show" url={`https://api.themoviedb.org/3/person/${id}/tv_credits?api_key=046fdb0d753c6903e673934705cb553f&language=en-US&page=1`} />
            </IonContent>
        </IonPage>
    );
};
